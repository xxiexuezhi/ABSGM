...
path_g1 = "/home/xxie92/projects/rrg-pmkim/xxie92/diffusion_model/protein-sgm-main/sampling/128_cath_s95_new_config_with_seq2_0916/tmp/"
...
#comb_num = len(target_coords)
   ...
   # saved_y = 99999
    ...
    for i in range(loops):
        ...
        pickle_out_W = open(path_g1+str(kkk)+"_"+name_f+"_to_save_lst_lst_dis50_save_memory_with_achor_ptrs_used_mcmc_on_heavychain_chain_only_nov_dec1_index_4_5_6_7_8.pickle","wb")
