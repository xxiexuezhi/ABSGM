...
#workdir = Path.cwd().joinpath("training","128_cath_s95_new_config_blosum62")
...
import pickle 
f_names = "dataset_antibody_light_heavy_all_info_0_4000_date0828_seq_encoded_with_blosum62.pkl"
...
from configs.config import get_configs
config = get_configs(batch_size=16,size=128,num_ch=5)
workdir = Path.cwd().joinpath("training","128_cath_s95_new_config_with_blosum62_2")
