...
def get_configs(batch_size=32,size=24,num_ch=2): # batch size previously is 16. I update into 8
    ...
    sampling.snr = 0.17
    sampling.method = 'ode' # this value previous is pc. i change it into ode
