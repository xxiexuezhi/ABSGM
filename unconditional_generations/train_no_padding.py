...
from configs.config_ode import get_configs
config = get_configs(batch_size=8,size=128,num_ch=5) # previous batch size is 8. increased to 16.
#workdir = Path.cwd().joinpath("training","128_cath_s95_new_config")

workdir = Path.cwd().joinpath("training","antigen_antibody_complex_antibody_only_using6d_plus_seq_Mar4_2023")
...
with open("encoded_antigen_antibody_complex_antibody_only_using6d_plus_seq_Mar4_2023.pkl","rb") as f:
    d1= pickle.load(f)
