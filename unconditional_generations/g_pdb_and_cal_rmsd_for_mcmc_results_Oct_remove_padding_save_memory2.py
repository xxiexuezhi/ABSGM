...
path_g2 = "/home/xxie92/scratch/mcmc_results_11/heavy_only/dis50_save_memory/re_run"# + str(kkk) +"/"
#subprocess.call(["mkdir",path_g2])


import subprocess
subprocess.call(["mkdir",path_g2])
path_g2 = "/home/xxie92/scratch/mcmc_results_11/heavy_only/dis50_save_memory/re_run/"+str(kkk) +"/"#+str(kkk2) + "/"
