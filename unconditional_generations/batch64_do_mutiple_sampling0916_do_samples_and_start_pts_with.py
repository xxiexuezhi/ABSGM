...
checkpoint_dir = Path.cwd().joinpath(
    ...
    "checkpoints",
    "checkpoint_34.pth"   # I change it back into 34. previous is 34, all mcmc and generation before is all done with 34. I just want to test 47 performance.
)
...
with open(workdir.joinpath("lst_latent_pts_and_samples_5120_one_hot_20_encoded_ode_only_25_with_decrease_sigmamax100_with_probability_flow_true_withbatch64_seq2_chekpoint34_oct_15_6.pkl"), "wb") as f:
