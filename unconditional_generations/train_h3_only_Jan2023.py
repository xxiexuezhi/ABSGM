...
config = get_configs(batch_size=16,size=32,num_ch=5) # previous batch size is 8. increased to 16.
#workdir = Path.cwd().joinpath("training","128_cath_s95_new_config")

workdir = Path.cwd().joinpath("training","128_cath_s95_new_config_h3_only_jan_2023")
