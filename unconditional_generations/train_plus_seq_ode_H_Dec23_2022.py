...
workdir = Path.cwd().joinpath("training","128_cath_s95_new_config_with_seq2_ode_heavychain_only_dec_2022")
...
with open("training_data_heavy_chain_only_Dec23_2022.pkl","rb") as f:
    d1= pickle.load(f)
