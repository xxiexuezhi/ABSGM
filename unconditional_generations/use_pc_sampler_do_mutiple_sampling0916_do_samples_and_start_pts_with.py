...
config = get_configs(batch_size=100,size=128,num_ch=5)
...
with open(workdir.joinpath("latent_pts_and_samples_40000_one_hot_20_encoded_Oct10_pc_only_0.pkl"), "wb") as f:
