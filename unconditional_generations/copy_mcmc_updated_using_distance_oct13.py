...
distance_ratio = 50 #40 forget to change last time # this is for eucudian distance btw encoded map of c-beta and c-beta
...
#comb_num = len(target_coords)
   ...
   # saved_y = 99999
    ...
    for i in range(loops):
        ...
        pickle_out_W = open(path_g1+str(kkk)+"_"+name_f+"_to_save_lst_lst_dis50_save_memory_with_achor_ptrs_used.pickle","wb")
