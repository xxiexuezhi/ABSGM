...
workdir = Path.cwd().joinpath("sampling","128_cath_s95_new_config_with_seq_pdb_80_128")
...
checkpoint_dir = Path.cwd().joinpath(
    "training",
    "128_cath_s95_new_config_with_seq_pdb_80_128",
    "checkpoints",
    "checkpoint_18.pth"
)
...
with open(workdir.joinpath("samples_pdb_80_128.pkl"), "wb") as f:
