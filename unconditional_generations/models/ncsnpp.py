...
# Removed progressive module and Fourier timestep embeddings
...
class NCSNpp(nn.Module):
  ...
  def __init__(self, config):
    ...
    # Finite impulse response: used for anti-aliasing in signal processing https://arxiv.org/pdf/1904.11486.pdf
