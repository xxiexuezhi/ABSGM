...
#"_to_save_lst_lst_dis50_save_memory_with_achor_ptrs_used_mcmc_on_heavychain_chain_only_nov_dec1_index_all_update_using_seq_sim.pickle"
#"_to_save_lst_lst_dis50_save_memory_with_achor_ptrs_used_mcmc_on_heavychain_chain_only_nov_dec1_index_all.pickle"
...
# this rest is to get replace sample

kkk3 = int(sys.argv[3])

nn_added = name_lst[kkk3]
#n_added = "0_4IOF_1_L_to_save_lst_lst_dis30.pickle"

ff_name = "./sampling/128_cath_s95_new_config_with_seq2_ode_heavychain_only_dec_2022/tmp/" +nn_added
...
target_sample = target_samples[kkk4]
...
def hack_h3(np_sample,kkk):
    ...
    target_sample = numpy.array(target_samples[kkk4])
...
# this function will not be used for geneate.
dis_lst = []
...
cal_h3_distance(test_d[kkk],samples)
