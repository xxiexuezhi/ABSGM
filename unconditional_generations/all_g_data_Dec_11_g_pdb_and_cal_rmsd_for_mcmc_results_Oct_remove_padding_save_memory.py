...
saved_lst_name = "_to_save_lst_lst_dis50_save_memory_with_achor_ptrs_used_mcmc_on_heavychain_chain_only_nov_dec1_index_all_update_using_seq_sim.pickle" # try to re-run 2,4,5 on seq_sim. results saved in dec30_2. previously is _to_save_lst_lst_dis50_save_memory_with_achor_ptrs_used_mcmc_on_heavychain_chain_only_nov_dec1_index_all and save in dec30. dated Jan 11 2023.
...
path_g2 = "/home/xxie92/scratch/mcmc_results_11/heavy_only/dis50_save_memory/dec30_2"# + str(kkk) +"/"
#subprocess.call(["mkdir",path_g2])


import subprocess
subprocess.call(["mkdir",path_g2])
path_g2 = "/home/xxie92/scratch/mcmc_results_11/heavy_only/dis50_save_memory/dec30_2/"+str(kkk) +"/"#+str(kkk2) + "/"
