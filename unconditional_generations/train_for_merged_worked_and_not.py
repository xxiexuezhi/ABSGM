...
with open("dataset_pdb_coord_6d_len80_len128_date_sep3_non_nan.pkl","rb") as f:
    d1= pickle.load(f)
with open("dataset_pdb_coord_6d_len80_len128_date_with_seq_sep5_4_1.pkl","rb") as f:
    d2= pickle.load(f)
...
from configs.config import get_configs
config = get_configs(batch_size=16,size=128,num_ch=5)
workdir = Path.cwd().joinpath("training","128_cath_s95_new_config_with_seq3_merged_80_worked_and_not_date_sep6")
