...
config = get_configs(batch_size=16,size=128,num_ch=5) # previous batch size is 8. increased to 16.
#workdir = Path.cwd().joinpath("training","128_cath_s95_new_config")

workdir = Path.cwd().joinpath("training","128_cath_s95_new_config_with_seq2_ode_lightchain_only_dec_2022")
...
with open("training_data_light_chain_only_Dec23_2022.pkl","rb") as f:
    d1= pickle.load(f)
