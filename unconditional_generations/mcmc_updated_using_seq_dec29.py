...
distance_ratio = 17 # this would be for seq chaennal , chanel 4 #50  #update back into 50 #update it into 55 only for heavey chain in index 0,2,4,5,6,8 #50 #40 forget to change last time # this is for eucudian distance btw encoded map of c-beta and c-beta
...
#comb_num = len(target_coords)
   ...
   # saved_y = 99999
    ...
    for i in range(loops):
        ...
        pickle_out_W = open(path_g1+str(kkk)+"_"+name_f+"_to_save_lst_lst_dis50_save_memory_with_achor_ptrs_used_mcmc_on_heavychain_chain_only_nov_dec1_index_all_update_using_seq_sim.pickle","wb")
