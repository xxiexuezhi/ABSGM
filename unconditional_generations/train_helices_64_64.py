...
from configs.config_ode64 import get_configs
config = get_configs(batch_size=32,size=64,num_ch=1) # previous batch size is 8. increased to 16.
#workdir = Path.cwd().joinpath("training","128_cath_s95_new_config")

workdir = Path.cwd().joinpath("training","helices_64_64_ch1")
...
with open("numpy_filter_rosettascore100_trainingdata_0512_64_64_for_protein_sgm.pkl","rb") as f:
    d1= pickle.load(f)
