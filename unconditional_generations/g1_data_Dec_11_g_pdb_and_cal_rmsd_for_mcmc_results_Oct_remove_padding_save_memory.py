...
for d in test_d:
    ...
    name = str(aaa)+"_"+name_f+ "_to_save_lst_lst_dis50_save_memory_with_achor_ptrs_used_mcmc_on_heavychain_chain_only_nov24_index0_2_4_5_6_8.pickle" #"_to_save_lst_lst_dis40.pickle"  #"_to_save_lst_lst.pickle"  #"_to_save_lst_lst_dis40.pickle"_heavychain_chain_only_nov24_index0_2_4_5_6_8
...
folder_name = "g1_heavy_chain"

path_g2 = "/home/xxie92/scratch/mcmc_results_11/heavy_only/dis50_save_memory/"+folder_name # + str(kkk) +"/"
#subprocess.call(["mkdir",path_g2])


import subprocess
subprocess.call(["mkdir",path_g2])
path_g2 = "/home/xxie92/scratch/mcmc_results_11/heavy_only/dis50_save_memory/"+folder_name+"/"+str(kkk) +"/"#+str(kkk2) + "/"
...
for i in range(a,b):
    ...
    for j in range(1):
        ...
        saved_lst.append([i,seq[start:end],rmsd,h3_seq,rmsd_h3,rmsd_h3_m1,rmsd_h3_p1])
        ...
        if rmsd < min_rmsd:
            ...
            #with open(path_g2+str(kkk)+"_i_generatedseq_rmsd_h3seq_rmsdh3_rmsdh3m1_rmsdh3p1.pickle","wb") as fout:
