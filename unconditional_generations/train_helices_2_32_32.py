...
config = get_configs(batch_size=32,size=32,num_ch=2) # previous batch size is 8. increased to 16.
#workdir = Path.cwd().joinpath("training","128_cath_s95_new_config")

workdir = Path.cwd().joinpath("training","helices_32_32_ch2")
...
with open("numpy_filter_rosettascore100_trainingdata_0512_2_32_32_for_protein_sgm.pkl","rb") as f:
    d1= pickle.load(f)
