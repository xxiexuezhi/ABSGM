...
workdir = Path.cwd().joinpath("training","128_cath_s95_new_config_with_seq2_chi_ode_heavychain_only_Mar2_2023")
...
with open("training_data_heavy_chain_only_adding_chi_ch4_80_92_Mar2_2023.pkl","rb") as f:
    d1= pickle.load(f)
