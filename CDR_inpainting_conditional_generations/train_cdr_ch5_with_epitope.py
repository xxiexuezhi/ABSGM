...
with open("protein_dataset_dataset3_l_with_epitope_match_cdr_4k_all_matching_info_add_after_masking_and_epitope_info_Mar8_2023.pkl","rb") as f:
...
def main():
    ...
    parser.add_argument('--resume', type=str, default="ch5_inpainted_updated_seq_masking_with_epitope_protein_dataset_dataset3_l_with_epitope_match_cdr_4k_all_matching_info_add_after_masking_and_epitope_info_Mar9_2023")
