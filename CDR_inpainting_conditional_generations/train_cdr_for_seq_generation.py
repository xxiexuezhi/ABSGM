...
import time
from utils import random_mask_batch, get_condition_from_batch, selected_mask_batch,selected_mask_batch2,selected_mask_batch4
import shutil

import pickle

name123 = "protein_dataset_dataset3_l_with_no_epitope_match_cdr_10k_all_matching_info_update_into_all_data_for_top_left_positions_with_no_padding_Mar10th.pkl"
with open(name123,"rb") as f:
...
def main():
    ...
    parser.add_argument('--resume', type=str, default=name123.split(".")[0])
...
#    with open("validation_set_protein_dataset_dataset3_l_with_epitope_match_cdr_4k_all_matching_info_add_after_masking_and_epitope_info_no_padding_midptr_64_Mar10_2023.pkl","wb") as fout:
 #       pickle.dump(test_ds,fout)
    ...
    for step in range(initial_step, config.training.n_iters + 1):
        ...
        batch = selected_mask_batch4(batch, mask_info, config)
        ...
        if step % config.training.eval_freq == 0:
            ...
            eval_batch = selected_mask_batch4(eval_batch, mask_info2, config)
