...
with open("merge_two_training_and_epitope_Mar07_2023.pkl","rb") as f:
...
def main():
    ...
    parser.add_argument('--resume', type=str, default="ch5_inpainted_updated_seq_masking_with_epitope_lr05_merge")
