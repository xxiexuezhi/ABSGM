...
#from dataset_for_ch2_angle import ProteinDataset
...
with open("dompdb_pdb_encoded_6d_coords_plus_seq_chi_dataset_on_Mar1.pkl","rb") as f:
...
def main():
    ...
    parser.add_argument('--resume', type=str, default="ch6_training_6d_plus_chi_plus_seq")
