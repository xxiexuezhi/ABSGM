...
def main():
    ...
    parser.add_argument('--resume', type=str, default="ch6_inpainted_updated_seq_masking_with_epitope_protein_dataset_dataset3_l_with_epitope_match_cdr_4k_all_matching_info_add_after_masking_and_epitope_info_Mar10_2023")
   ...
   # dataset = ProteinDataset(config.data.dataset_path, config.data.min_res_num,
    ...
    #import pickle
    with open("validation_set_protein_dataset_dataset3_l_with_epitope_match_cdr_4k_all_matching_info_add_after_masking_and_epitope_info_no_padding_midptr_64_Mar10_2023.pkl","wb") as fout:
